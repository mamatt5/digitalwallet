...
function PaymentScreen({ route, navigation }) {
  ...
  const handleConfirmPayment = async () => {
    ...
    const transaction = {
      ...
      amount: parsedData.amount * (1 - discount),
    ...
    if (userVouchers.length != 0 && selectedVoucher.voucher_id != "voucher_id") {
      deleteVoucher()
    }
        ...
        <View style={styles.qrData}>
          {isValidQR ? (
            ...
            {voucherScreen && (
              ...
              <Text style={styles.headerText}> Select Voucher</Text>
                  ...
                  <TouchableWithoutFeedback onPress={closeConfirmationModal}>
                    <View style={styles.modalContainer}>
                      <View style={styles.modalContent}>
                        ...
                        <Text style={styles.text}>Your new total will be ${(parsedData.amount * (1-discount)).toFixed(2)} {"\n"}</Text>
                        
                        <Text style={styles.text}>Once this voucher is used it cannot be used again</Text>
