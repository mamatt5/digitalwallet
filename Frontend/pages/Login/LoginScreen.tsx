    ...
    <SafeAreaView style={{ backgroundColor: '#0f003f', height: 2000 }}>
      <ScrollView>
        <View style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <Text onPress={() => navigation.navigate('GenerateQRUser')} style={{ color: '#ffffff', marginTop: 20 }}>
            Generate QR User
          </Text>
          <Text onPress={() => navigation.navigate('GenerateQRMerchant')} style={{ color: '#ffffff', marginTop: 20 }}>
            Generate QR Merchant
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
